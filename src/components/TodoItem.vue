<template>
  ...
  <q-item-section avatar class="hide-icon close-icon" @click="deleteBefore">
  ...
  <q-dialog v-model="confirm" persistent>
    <q-card>
      ...
      <q-card-actions align="right">
        ...
        <q-btn flat label="Yes" color="primary" v-close-popup @click="handleClickDelete" />
      </q-card-actions>
    </q-card>
  </q-dialog>
...
export default {
  ...
  methods: {
    deleteBefore(){
      this.confirmText=`Are you sure delete the ${this.item.title} item?`;
      this.confirm=true;
    },
    handleClickEdit() {
      this.editing = true
